...
export default function DisclosuresPage() {
  return (
    <article className="max-w-3xl">
      <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">Disclosures</h1>
      ...
      <ol className="mt-8 space-y-5">
        {DISCLOSURES.map((d, i) => (
          <li key={d.title} className="rounded-2xl border border-border bg-bg-elevated p-4 sm:p-5">
