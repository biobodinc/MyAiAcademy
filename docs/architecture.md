...
| Domain services | `hardware/` (detection, live metrics, benchmark), `storage/` (layout, usage, cleanup), `profile/`, `preferences/`, `skills/`, `commands/`, `guide/`, `audit/`, `status/`, `models/`, `chat/`, `memory/`, `knowledge/` | Plain Python; no FastAPI imports. Each has a Pydantic schema module and is unit-tested without HTTP.                                                                                                                                                                                                                                                                          |
